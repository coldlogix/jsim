...
device *
resis_to_devlist(name, type, nodeptr, dataptr)
...
device *
resis_to_deftree(dev_name, type, nodeptr, dataptr)
...
device *
resissub_to_devlist(dev_name, type, data)
...
device *
add_resis(name, val, n_plus, n_minus)
...
void
resis_tran_print(fp, inc_rate, prtype, temp_dev)
