...
device *
cap_to_devlist(name, type, nodeptr, dataptr)
...
device *
cap_to_deftree(dev_name, type, nodeptr, dataptr)
...
device *
capsub_to_devlist(dev_name, type, data)
...
device *
add_cap(name, val, ic, n_plus, n_minus)
...
void
cap_tran_print(fp, inc_rate, prtype, temp_dev)
