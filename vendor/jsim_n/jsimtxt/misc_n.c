...
int
read_int(val, error_message, no_mess_if_blank)

int *val;
char *error_message;
int no_mess_if_blank;
{
  int i;
...
int
read_long(val, error_message, no_mess_if_blank)
...
int
read_double(val, error_message, no_mess_if_blank)
