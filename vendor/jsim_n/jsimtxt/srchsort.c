...
void
merge_copy(the_array, lower, upper)
...
void
sort_dev(dev_array, lower, upper)
...
long *
get_dev_array(no_sort, dev_list, dev_count)
...
device *
search_dev(dev_array, dev_count, name)
...
device *
search_name_dev(dev_array, dev_count, name)
...
void
sort_sub_def(sub_def_array, lower, upper)
...
long *
get_sub_def_array(sub_def_list, sub_def_count)

sub_def *sub_def_list;
long sub_def_count;
{
...
sub_def *
search_sub_def(sub_def_array, sub_def_count, name)
