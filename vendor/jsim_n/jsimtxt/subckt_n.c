...
void
new_sub_def(name, intptr, nodeptr)
...
device *
subckt_to_devlist(name, type, nodeptr, intptr, modptr)
...
device *
subckt_to_deftree(dev_name, type, nodeptr, intptr, modptr)
...
device *
add_sub_ckt(name, no_node, node_list, sub_def_name)
...
long
getnode_subnode(subnode, subnode_index)

int subnode, subnode_index;
{
  int i;
...
device *
sub_to_devlist(dev_name, type, data)
