...

{
  ...
  if (jsim_raw) {
    ...
    for (pl = print_list; pl; pl = pl->next_print, raw_cntr++) {
      ...
      if (pl->print_dev->type == TRAN_NO_LOSS) {
...
void
print_dev_array(dev_array, dev_count)
...
void
myprint_deftree(the_sub_def, fp)
