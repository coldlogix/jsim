...
int
add_node(node, name, devtype, nodetype, bmarker)

int node;
long name;
int devtype, nodetype;
...
void
trace_subgraph(nodeptr, source_only)
...
void
trace_connect(nodeptr, dcpath_only)
